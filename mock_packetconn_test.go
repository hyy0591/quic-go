...
//
//	mockgen -typed -package quic -self_package github.com/hyy0591/quic-go -self_package github.com/hyy0591/quic-go -destination mock_packetconn_test.go net PacketConn
//
